...
archipelago_subtheme_nysa theme uses [Webpack](https://webpack.js.org) to compile and
bundle SASS and JS.
...
Go to the root of archipelago_subtheme_nysa theme and run the following commands:
`nvm use`
...
`drush en archipelago_subtheme_nysa -y`
`drush config-set system.theme default archipelago_subtheme_nysa -y`
